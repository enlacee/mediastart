                    ...
                    <div class="col-md-12 mgTop20">
                        <div class="floatRight">
                            <span class="ft_Oswald mayuscula color_ft414447 mgRight10">
                                <a href="#link" target="_blank">Client Zone</a>
                            </span>
                        ...
                        <div role="navigation" class="navbar navbar-default menuStyle">
                            <div class="container-fluid">
                                <div class="navbar-header">
                                  ...
                                  <a href="<?php echo base_url() ?>" class="navbar-brand" id="logo"><img src="<?php echo getPublicUrl() ?>/images/menu/logo.png" class="img-responsive" width="221" height="79" /></a>
                                </div>
