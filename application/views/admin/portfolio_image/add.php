<div class="col-md-12">
    ...
    <?php $this->load->view('admin/portfolio_image/_gallery.php', array('data' => array())) ?>

    <form name="form" id="form" method="post" action="<?php echo base_url("admin_portfolio_image/add/true") ?>">
                ...
                <tr>
                    ...
                    <td width="85%" class="text-left">
                        <span class="pdRight20 center-block">
                            <input type="text" name="title" id="title" class="form-control required" placeholder="Name" minlength="3"
                                   value="">
                        </span>
                    </td>
                </tr>
