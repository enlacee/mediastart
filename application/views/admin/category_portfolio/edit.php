<div class="col-md-12">
    ...
    <?php if (isset($data) && !empty($data) && is_array($data)) : ?>
        <form name="form" id="form" method="post" 
              action="<?php echo base_url('admin_category_portfolio/edit/' . $data['id'] . '/true') ?>">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left">
                    ...
                    <option <?php echo ($data['status'] == Category_portfolio_model::STATUS_TRUE ) ? 'selected="selected"' : '';?> value="1">On</option>
                    <option <?php echo ($data['status'] == Category_portfolio_model::STATUS_FALSE ) ? 'selected="selected"' : '';?>value="0">Off</option>
                    </select>
                  </td>
                </tr>                
