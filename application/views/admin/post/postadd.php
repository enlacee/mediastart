<div class="col-md-12">
    ...
    <form name="form" id="form" method="post" action="<?php echo base_url('admin_post/postadd/true') ?>">
                ...
                <tr>
                    ...
                    <td width="85%" class="text-left">
                        <span class="pdRight20 center-block">
                            <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Title" value="">
                        </span>
                    </td>
                </tr>
                <tr>
