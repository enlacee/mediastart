<div class="col-md-12">
    <h1><?php echo $page_title; ?> : <a href="<?php echo base_url("admin_portfolio/add") ?>" class="btn btn-primary">Add</a></h1>                        
            ...
            <?php if (isset($data) && is_array($data) && count($data) > 0) : ?>
                ...
                ?>                  
                    <tr>
                        ...
                        &nbsp;
                        <a href="<?php echo base_url("/admin_portfolio/del/" . $array['id']) ?>"><img src="<?php echo getPublicUrl() ?>/images/borrar.png" width="20" height="20" /></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>                                
        ...
        <div class="text-center pdTop10" id="paginador">
            <ul class="pagination">
                ...
                <?php if ($pag['page'] == 1) : ?>
                    ...
                    <li><a href="<?php echo base_url("admin_portfolio/index/{$i}") ?>"><?php echo $i;?></a></li>
                    <?php endfor; ?>                    

                    <?php if ($pag['last_page'] > $pag['page'] ) : ?>
                    <li class="next"><a href="<?php echo base_url("admin_portfolio/index/{$nextpage}") ?>" >Next &raquo;</a></li>
                    <?php else : ?>
                        <li class="disabled"><a href="#">Next &raquo;</a></li> 
                    <?php endif; ?>

                <?php else : ?>
                        <li class="previous"><a href="<?php echo base_url("admin_portfolio/index/{$prevpage}") ?>">&laquo; Previous</a></li>                   
                    ...
                    <?php if ($pag['last_page'] > $pag['page']) : ?>
                            <li><a href="<?php echo base_url("admin_portfolio/index/{$nextpage}") ?>">Next &raquo;</a></li>
                    <?php else : ?>
                        <li class="disabled"><a href="#">Next &raquo;</a></li>
                    <?php endif; ?>     
