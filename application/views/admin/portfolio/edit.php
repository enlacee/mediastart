<div class="col-md-12">
    ...
    <?php if (isset($data) && !empty($data) && is_array($data)) : ?>
        <form name="form" id="form" method="post" action="/admin_portfolio/edit/<?php echo $data['id'] ?>/true">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left">
                    ...
                    <option value="">-</option>                    
                    <option <?php echo ($data['status'] == Portfolio_model::STATUS_TRUE ) ? 'selected="selected"' : '';?> value="1">1</option>
                    <option <?php echo ($data['status'] == Portfolio_model::STATUS_FALSE ) ? 'selected="selected"' : '';?>value="0">0</option>
                    </select>
                  </td>
                </tr>                
