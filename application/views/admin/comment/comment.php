<div class="col-md-12">
        <?php if (is_array($post) && isset($post['title']) ): ?>
    <h1>Comments on “<?php echo $post['title'] ?>”</h1>
        <?php endif; ?>
            ...
            <?php if (is_array($data) && count($data) > 0) : ?>
                <?php foreach ($data as $array) :?>              
                    <tr>
                        ...
                        &nbsp;
                        <a href="/admin_comment/commentdel/<?php echo $array['id'] ?>"><img src="<?php echo getPublicUrl() ?>/images/borrar.png" width="20" height="20" /></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>                                
            ...
            <ul class="pagination">
                ...
                <?php if ($pag['page'] == 1) : ?>
                    ...
                    <?php for ($i = $pag['page']+1; $i <= $pag['last_page']; $i++) : ?>
                        <li><a href="/admin_comment/comment/<?php echo $idPost; ?>/<?php echo $i;?>"><?php echo $i;?></a></li>
                    <?php endfor; ?>                    

                    <?php if ($pag['last_page'] > $pag['page'] ) : ?>
                        <li class="next"><a href="/admin_comment/comment/<?php echo $idPost; ?>/<?php echo $nextpage;?>" >Next &raquo;</a></li>
                    <?php else : ?>
                        <li class="disabled"><a href="#">Next &raquo;</a></li> 
                    <?php endif; ?>

                <?php else : ?>
                    <li class="previous"><a href="/admin_comment/comment/<?php echo $idPost; ?>/<?php echo $prevpage;?>">&laquo; Previous</a></li>                   
                    ...
                    <?php if ($pag['last_page'] > $pag['page']) : ?>
                        <li><a href="/admin_comment/comment/<?php echo $idPost; ?>/<?php echo $nextpage;?>">Next &raquo;</a></li>
                    <?php else : ?>
                        <li class="disabled"><a href="#">Next &raquo;</a></li>
                    <?php endif; ?>     
